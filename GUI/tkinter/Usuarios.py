...
class Usuarios(object):
    ...
    def upadateUser(self):
        ...
        try:
            ...
            c.execute("update usuario set nome = '"+ self.nome +"', telefone = '"+ self.telefone +"', email = '"+ self.email +"', usuario = '"+ self.usuario +"', senha = '"+ self.senha +"' where idusuario = "+ self.idusuario +" ")
    ...
    def deleteUser(self):
        ...
        try:
            ...
            return "Usuário exlcuido com sucesso!"
        except:
            return "Ocorreu um erro na exclusão do úsuario"
